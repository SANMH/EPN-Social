            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("category")) {
                        ...
                        if (category.equals("FISICA Y MATEMÁTICAS")) {
                            mImageViewCategory.setImageResource(R.drawable.buho);

                        }
                        else if (category.equals("INGLÉS")) {
                            mImageViewCategory.setImageResource(R.drawable.buho);
                        }
                        else if (category.equals("INFORMÁTICA")) {
                            mImageViewCategory.setImageResource(R.drawable.buho);
                        }
                        else if (category.equals("REDES")) {
                            mImageViewCategory.setImageResource(R.drawable.buho);
                        }
                    }
